...
class DraftForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        BAN_CHOICES = [("",""),(DraftForm.NO_BAN,"No Ban")]+CHAMPION_CHOICES
        ...
        for team in teams:
            ...
            for pick_count in range(NUM_PICKS):
                ...
                self.fields[name] = forms.TypedChoiceField(coerce=int, empty_value=None, widget=forms.Select(attrs=widget_attrs), label="Pos", choices=DraftForm.POSITION_CHOICES, required=False)
